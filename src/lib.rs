...
pub fn extract_boundary(input_path: &str, output_path: &str) -> ((u32,u32),(u32,u32),(u32,u32),(u32,u32)) {
    ...
    boundary_img.save("data/boundary.png").expect("Failed to save output image");
    ...
    northmost = *north_candidates.get(north_candidates.len() / 2 - 1).unwrap_or(&northmost);
    ...
    (westmost, eastmost, northmost, southmost)
}